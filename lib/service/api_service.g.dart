...
class _ApiService implements ApiService {
  _ApiService(
    ...
    baseUrl ??= 'https://prestashop.webkul.com';
  }
  ...
  @override
  Future<MyModel> getPosts() async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final Map<String, dynamic>? _data = null;
    final _result =
        await _dio.fetch<Map<String, dynamic>>(_setStreamType<MyModel>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = MyModel.fromJson(_result.data!);
    return value;
  }
